                ...
                <div class="carousel-inner">
                    <div class="carousel-item active h-100">
                        <div class="card bg-dark text-white d-flex">
                            <img
                                src=""
                                class="promotion-carousel card-img rounded-1 w-100 d-block" alt="...">
                                <div class="d-block bg-dark bg-gradient card-img-overlay d-flex align-items-end">
                                    <div>
                        ...
                        <div class="carousel-item h-100" v-for="(e, i) in this.listPromos.products" :key="i">
                            <div class="card d-block bg-dark bg-gradient text-white ">
                                <img  :src="'/storage/products/imgs/'+e.img" class="promotion-carousel card-img rounded-1 w-100 d-block">
