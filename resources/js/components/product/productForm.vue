<template>
    ...
    <div>
        <div v-if="this.deleteForm">
            <p>¿Estas seguro de eliminar el producto N°{{ this.formConfig.item }}</p>
        </div>
        <div v-else>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <label for="stock" class="col-md-4 col-form-label text-md-end">Cantidad:</label>
                <div class="col-md-6">
                    <input id="stock" type="number" class="form-control" name="stock" required v-model="this.$parent.formContent.stock">
                </div>
                <div v-if="this.formResponse.reject" class="col-mb3 d-flex justify-content-center text-danger">
                    <p v-for="(e, i) in this.formResponse.data.errors.stock" :key="i">{{ e }}</p>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="img" type="file" accept="image/png,  image/jpeg" class="form-control" name="img" required @change="this.$parent.addFile">
                </div>
                <div v-if="this.formResponse.reject" class="col-mb3 d-flex justify-content-center text-danger">
                    <p v-for="(e, i) in this.formResponse.data.errors.name" :key="i">{{ e }}</p>
                </div>
...
export default {
    ...
    created(){
        ...
        this.autoloadProduct = setInterval(()=>{
